    ...
    return (
        <div className=" mx-auto my-10 ">
            <div className="relative flex w-72  md:w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md mx-auto mt-32">
                <div className="relative mx-2  md:mx-4 -mt-6 mb-4 grid h-20 md:h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-r from-[#6f4e37] to-[#4b2c1c]  bg-clip-border text-white shadow-lg shadow-[#4b2c1c]">
                ...
                <div className="card flex-shrink-0  md:w-full max-w-xs md:max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleSubmit} className="card-body">
                        ...
                        <div className="form-control mt-6 p-0">
                            <button className="btn  bg-gradient-to-r from-[#6f4e37] to-[#4b2c1c]  text-white" type='submit'>Register</button>
                        </div>
